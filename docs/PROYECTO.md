...
7. **Juez** (`judge_moment_scores`): puntúa el texto real del clip + overlay + hook contra una rúbrica con anclas; devuelve `hook/retention/shareability/reasoning`. Si falla, quedan los scores de la Pasada A (`score_llm`).
