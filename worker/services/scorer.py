...
Puntúa contra la rúbrica. Responde SOLO JSON."""
    ...
    try:
        ...
        # W6 + W10 subieron esto por separado (500→2000): el reasoning
        # constructivo de 2-3 frases se muestra completo en la UI ("Por qué
        # este score", ViralMomentCard) y 500 chars lo cortaba a mitad de
        # palabra. TASK_MAX_TOKENS["judge"] (config/model_tiers.py) ya
        # acota el tamaño total de la respuesta — este cap es solo una red de
