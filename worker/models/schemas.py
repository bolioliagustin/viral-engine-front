...
class ViralMoment(BaseModel):
    ...
    # clip_not_rendered) que arma main.py al persistir el momento; ese merge
    # final ("clip_quality_issues = build_clip_quality_issues(...) + (moment.
    # clip_quality_issues or [])") lo hace quien toque main.py — ver reporte.
